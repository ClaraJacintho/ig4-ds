...
# __________________ MOMENT_JOURNE ____________________________________________________________ 
...
ggplot(respAprofAc, mapping = aes(x=respAprofAc$MOMENTJOURNEE)) + geom_bar()
